...
public class IsoMapHoverController {
    ...
    private void loadCursors() {
        normalCursor = new ImageCursor(new Image("cursors/" + CursorType.NORMAL.getPngName()), 0, 0);
        attackCursor = new ImageCursor(new Image("cursors/" + CursorType.ATTACK.getPngName()), 0, 0);
        attackDistCursor = new ImageCursor(new Image("cursors/" + CursorType.ATTACK_DIST.getPngName()), 0, 0);
    }
